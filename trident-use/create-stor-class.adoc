...
== 配置Kubnetes StorageClass对象
 ...
 https://kubernetes.io/docs/concepts/storage/storage-classes/["Kubnetes StorageClass对象"^]将Astra Trident标识为用于该类的配置程序、并指示Astra Trident如何配置卷。例如：
...
Asta Trident提供 https://github.com/NetApp/trident/tree/master/trident-installer/sample-input/storage-class-samples["适用于特定后端的简单存储类定义"^]。
