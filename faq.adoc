...
是的，Astra Trident 可以脱机安装。请参阅 link:./trident-install/kubernetes-deploy.html["了解有关Astra Trident安装的信息"^]。
...
如果需要，您可以在本地生成和修改 Astra Trident 用于安装的确切清单文件。请参阅link:trident-install/kubernetes-customize-deploy-tridentctl.html["自定义tridentctl安装"^]。
