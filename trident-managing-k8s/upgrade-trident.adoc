...
* 如果您要从四版本窗口之外的版本进行升级，请执行多步骤升级。使用您要升级的早期版本的升级说明，升级到符合四版本窗口的最新版本。例如，如果您运行的是 22.01 并希望升级到 24.06：
+
.. 首次从22.07升级到23.04。
.. 然后从23.04升级到24.06。
...
一般来说，您应该使用与初始安装相同的方法进行升级，但您可以link:../trident-install/kubernetes-deploy.html#moving-between-installation-methods["在安装方法之间切换"]。升级 Astra Trident 有两种选择。
